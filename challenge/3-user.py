...
class User():
    ...
    def __init__(self):
        ...
        self.__password = None  # Initialize the private password as None
...
if __name__ == '__main__':
    ...
    if user_1.password == u_pwd:
        print("User.password should be hashed")  # This should not print because the password should be hashed
